...
class IntakeFilter extends StatefulWidget {
  @override
  _IntakeFilterState createState() => _IntakeFilterState();
}

class _IntakeFilterState extends State<IntakeFilter> {
  String intake = "";
  String displayName;
  String email;
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: TextField(
            ...
            decoration: InputDecoration(hintText: 'Search by Intake'),
            onChanged: (val) => initiateSearch(val),
          ),
          centerTitle: true,
        ),
        body: StreamBuilder<QuerySnapshot>(
          stream: intake != "" && intake != null
              ? Firestore.instance
                  .collection('/student')
